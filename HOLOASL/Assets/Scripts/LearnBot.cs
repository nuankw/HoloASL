...
public class LearnBot : MonoBehaviour
{

    /// <summary>
    /// Static instance of this class
    /// </summary>
    public static LearnBot Instance;
    ...
    {
        if(LearnOrganizer.Instance != null && LearnOrganizer.Instance.botResponseText!=null
            && LearnOrganizer.Instance.botResponseText.text!=null)
        LearnOrganizer.Instance.botResponseText.text = responseString;
    }
