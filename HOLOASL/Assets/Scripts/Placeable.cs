...
public class Placeable : MonoBehaviour
{
    ...
    public void OnPlacementStart()
    {
        ...
        IsPlacing = true;
        LearnBot.Instance.SetBotResponseText("Horizontal placeable surfaces will be shown in green.\nTry tapping on some placeable surface\n and your trainer will appear there!");
    ...
    public void OnPlacementStop()
    {
        ...
        GameObject trainerBot = GameObject.FindGameObjectsWithTag("BotTag")[0];
        ...
        Quaternion textRotation = trainerBot.transform.rotation;
